...
void interprete::display()
{
    ...
    for(unsigned int i = 0u; i<pDouble.getTaillePile(); i++)
    {
...
{
    for(unsigned int i = 0u; i<pString.getTaillePile(); i++)
    {
...
{
    QFile fin("C:/Users/Maxime/Documents/prog/Projet final c++/build-projet_final_c++-Desktop_Qt_5_2_1_MinGW_32bit-Debug/debug/ptitebite");
    QString stockage;
    bool test = 0;
    QChar temp;
